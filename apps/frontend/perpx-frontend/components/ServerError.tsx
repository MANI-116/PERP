...
export function ServerError({ message = "Something went wrong" }: { message?: string }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
      <div className="w-16 h-16 rounded-full bg-zinc-800 flex items-center justify-center mb-2">
        <svg className="w-8 h-8 text-[#f23645]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <h2 className="text-xl font-semibold text-zinc-300">Server error</h2>
