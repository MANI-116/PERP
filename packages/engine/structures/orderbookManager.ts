...
export class OrderBookManager {
    ...
    private constructor(private marketManager:MarketManager,
    ...
    static createFromSnapshot(snapshot: string,marketManager:MarketManager, userManager:UserManager): OrderBookManager | null {
        // recovery
